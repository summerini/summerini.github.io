---
title: "[15일차] HTTP 프로토콜 & Web 기술"
excerpt: "HTTP 요청과 응답 규칙, HTML 태그 사용법 (이어서)"
...
- 네트워킹
    1. **Connection Oriented (연결지향)**
        ...
        3. statcful / stateless
            1. statcful - 한번 연결한 후 연결을 끊을 때까지 여러번 통신 예) ssh, FTP, 채팅, googlemeet
            2. 단점 - 많은 클라이언트에게 응답을 못함, 보완) 멀티쓰레딩 기술
            3. stateless - 한번 연결에 한번 통신, 매번 연결
        
    2. **Connectionless (비연결)**
        1. 연결없이 데이터 전송
            1. ex) 편지, 방송
        2. 대표적 UDP
            1. 데이터 전송 신뢰성 x → 별도의 처리 필요
